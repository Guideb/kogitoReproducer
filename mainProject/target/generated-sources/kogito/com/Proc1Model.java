...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "proc1", name = "Proc1", hidden = false)
public class Proc1Model implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<Proc1ModelOutput> {
    ...
    @Override()
    public Proc1ModelOutput toModel() {
        Proc1ModelOutput result = new Proc1ModelOutput();
        result.setId(getId());
